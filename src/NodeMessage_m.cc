...
void NodeMessage_Base::setHeader(const messageHeader& header)
{
    this->header = header;
}
...
control& NodeMessage_Base::getPiggybacking()
{
    return this->piggybacking;
}

void NodeMessage_Base::setPiggybacking(const control& piggybacking)
{
    this->piggybacking = piggybacking;
}

int NodeMessage_Base::getPiggybackingId() const
{
...
const char *NodeMessageDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(messageHeader));
        case 3: return omnetpp::opp_typename(typeid(control));
        default: return nullptr;
    };
}
...
void *NodeMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)(&pp->getPiggybacking()); break;
        default: return nullptr;
    }
}
